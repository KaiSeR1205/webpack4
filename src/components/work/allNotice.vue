      ...
      <div>
        <el-dialog class="dialogForm" :visible.sync="dialogFormVisible" :close-on-click-modal="false" center>
          ...
          <el-form label-width="100px" size="mini" label-position="left">
            ...
            <div v-show="formData.app_state>2">
              <div class="row flex-h" style="padding-left: 15px;">
                ...
                <div style="font-size:12px">
                  <div class="label contentBlack" style="font-size:20px">{{formData.app_state==3?'审批已经通过':'审批未通过'}}
                  </div>
            ...
            <div class="flex-h align_center" style="height:60px;margin-left: 15px;" v-show="formData.app_state==2">
        ...
        <el-dialog width="80%" class="dialogApplying" :visible.sync="dialogApplyingVisible"
          ...
          <div style="height:100%;padding-top:10px">
            <basci-grid ref="searchGrid" :pagination="searchPagination" :config="searchGrid" @row-dbclick="rowDbClick"
              @current-change="getSearchGridData"></basci-grid>
          </div>
        </el-dialog>
      </div>
    </el-tabs>
