      ...
      <div>
        ...
        >
          ...
          <div>
            <el-button
              size="small"
              @click="dialogErrorVisible=false"
              style="width:200px"
              type="primary"
            >我知道了</el-button>
          </div>
...
export default {
  ...
  data: function() {
    return {
      ...
      dialogErrorVisible: true, //提交错误弹出层开关
      formData: {
        //表单数据
        approveState: "",
        approveReason: ""
  ...
  watch: {
    "search.value": function(n, o) {
      if (n == "") {
        this.gridType = "basciColumns";
      } else {
        this.gridType = "searchColumns";
      }
